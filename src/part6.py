...
<p><strong>本课流程一眼看</strong>：测试生成就是把左边一堆文档，一路加工成右边可评测的测试集 👇</p>
<div class="flow">
  <div class="node"><div class="nt">📄 docs</div><div class="nd">你的文档</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">KnowledgeGraph</div><div class="nd">节点 + 关系</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">personas</div><div class="nd">虚拟提问者</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">scenarios</div><div class="nd">谁问·哪些节点·风格</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">samples</div><div class="nd">问答对</div></div>
  <div class="arrow">→</div>
  <div class="node hl"><div class="nt">Testset</div><div class="nd">→ 回评测线</div></div>
</div>
...
<div class="card key">
  ...
  <ul>
    ...
    <li>测试生成是一条<strong>可复现的流水线</strong>：先把文档建成知识图谱，再在图上按 persona / 题型自动出题、汇成 Testset。</li>
...
在节点之间连<strong>边</strong>，组成一张 <span class="inline">KnowledgeGraph</span>（知识图谱）——它是整条测试生成流水线的<strong>中枢数据结构</strong>。
</p>
...
真正把它<strong>加工成富图</strong>（切块、抽摘要 / 关键词 / 实体、按相似度连边）的，是一组叫 <span class="inline">Transforms</span> 的变换。
...
<p><strong>本课流程一眼看</strong>：四类 transform 把光秃秃的文档加工成富知识图谱（典型顺序，实际 <span class="mono">default_transforms</span> 编排见下方代码）👇</p>
<div class="flow">
  <div class="node"><div class="nt">文档大节点</div><div class="nd">DOCUMENT</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">Splitter</div><div class="nd">切成小块</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">Extractor</div><div class="nd">抽摘要/关键词/实体</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">NodeFilter</div><div class="nd">剔除不合格</div></div>
  <div class="arrow">→</div>
  <div class="node hl"><div class="nt">RelationshipBuilder</div><div class="nd">连边 → 富知识图谱</div></div>
</div>
...
ragas 把这两层变化拆成 <span class="inline">Persona</span>（谁在问）和 <span class="inline">Scenario</span>（怎么问），用<strong>组合</strong>撑开测试集的多样性。
</p>
...
LESSON_29 = r"""
<p class="lead" style="font-size:1.06rem;color:var(--muted);margin-top:-.6rem">
有了知识图谱、persona 和 scenario 配方，谁来真正"出题"？答案是 <span class="inline">Synthesizer</span>（合成器 / 出题官）。
...
<p><strong>本课流程一眼看</strong>：出题官分两步，把图谱变成问答样本 👇</p>
<div class="flow">
  <div class="node"><div class="nt">KG + persona</div><div class="nd">节点簇 + 虚拟提问者</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">generate_scenarios</div><div class="nd">配 persona×风格×长度×节点</div></div>
  <div class="arrow">→</div>
  <div class="node"><div class="nt">generate_sample</div><div class="nd">LLM 出题 + 参考答案</div></div>
  <div class="arrow">→</div>
  <div class="node hl"><div class="nt">问答样本</div><div class="nd">单跳 / 多跳</div></div>
</div>
...
LESSON_30 = r"""
<p class="lead" style="font-size:1.06rem;color:var(--muted);margin-top:-.6rem">
前面五课的零件——知识图谱、transforms、persona、scenario、synthesizer——到这里被 <span class="inline">TestsetGenerator</span> <strong>串成一条龙</strong>：
...
<p><strong>本课流程一眼看</strong>：TestsetGenerator 把一堆文档一路串成可评测的测试集 👇</p>
<div class="vflow">
  <div class="step"><div class="num">1</div><div class="sc"><div class="vt">投入文档</div>
    <p>docs 进场（也可走 <span class="mono">from_langchain</span> / <span class="mono">from_llama_index</span>）</p></div></div>
  <div class="step"><div class="num">2</div><div class="sc"><div class="vt">建知识图谱</div>
    <p>transforms 切块 / 抽属性 / 连边（<a href="26-knowledge-graph.html">第 26 课</a>、<a href="27-transforms.html">第 27 课</a>）</p></div></div>
  <div class="step"><div class="num">3</div><div class="sc"><div class="vt">定题型配比</div>
    <p><span class="mono">default_query_distribution</span> 分配单跳 / 多跳（<a href="29-synthesizers.html">第 29 课</a>）</p></div></div>
  <div class="step"><div class="num">4</div><div class="sc"><div class="vt">生成 personas</div>
    <p>从 KG 自动产出虚拟提问者（<a href="28-persona-scenario.html">第 28 课</a>）</p></div></div>
  <div class="step"><div class="num">5</div><div class="sc"><div class="vt">并发出题</div>
    <p>复用 <span class="mono">Executor</span> 跑 scenarios → samples</p></div></div>
  <div class="step"><div class="num">6</div><div class="sc"><div class="vt">Testset → to_evaluation_dataset</div>
    <p>打包成 <span class="mono">Testset</span>，再一键回到评测线</p></div></div>
</div>
